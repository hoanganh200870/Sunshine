...
public class Utility {
    ...
    public static boolean isMetric(Context context) {
        ...
        boolean isImperial = unitType.equals(defaultValue);
        return isImperial;
    }
    ...
    public static String formatTemperature(Context context, double temp, boolean isMetric) {
        ...
        String format = context.getString(R.string.format_temperature, temp);
        return format;
    }
    ...
    public static String getFormattedWind(Context context, float windSpeed, float degrees) {
        ...
        String format = context.getString(windFormat);
        String formatString = String.format(format, windSpeed, direction);
        return formatString;
    }
